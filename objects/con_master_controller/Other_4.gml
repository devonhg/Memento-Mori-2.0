...
#region Main Room 
	if( room == rm_main ){
		...
		//Populate Main Buttons
			scr_add_primary_button( x_at_fraction(6), y_at_fraction(11), "Meditate", scr_call_meditate );
			
		//Initiate our settings drawer
			var _drwer_settings = scr_drawer( "Drawers", false, "Settings", "Tweak the app to your liking." );
			scr_add_primary_button( 0, y_at_fraction(-1.2 + _adjust), "Change Day", scr_btn_update_dd, 0, _drwer_settings );
			
		//Initiate our menu drawer
			var _drwer_menu = scr_drawer( "Drawers", false, "Menu", "Access Features" );
			scr_add_primary_button( 0, y_at_fraction(-1.2 + _adjust), "Todays Quote", vw_btn_call_qotd, 0, _drwer_menu );
			scr_add_primary_button( 0, y_at_fraction(0 + _adjust), "Feedback", scr_call_feedback, 0, _drwer_menu );
			scr_add_primary_button( 0, y_at_fraction(1.2 + _adjust), "About", scr_call_about, 0, _drwer_menu );
		...
		//Initiate our Meditation drawer
			...
			scr_add_primary_button( 0, y_at_fraction(1.2 + _adjust), "30 Minutes", scr_btn_med_30, 0, _drawer_meditation );
			scr_add_primary_button( 0, y_at_fraction(0 + _adjust), "20 Minutes", scr_btn_med_20, 0, _drawer_meditation );
			scr_add_primary_button( 0, y_at_fraction(-1.2 + _adjust), "10 Minutes", scr_btn_med_10, 0, _drawer_meditation );
